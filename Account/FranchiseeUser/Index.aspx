<%@ page title="My Account - Franchisee Index" language="C#" masterpagefile="~/CRM.master" autoeventwireup="true" inherits="Account_FranchiseeUser_Index, App_Web_2wvaqxva" %>
    ...
    <table id="tblMain" width="100%">
        <tr>
            <td style="width: 100%" align="right">
                <a href="Add.aspx" id="addFranchiseeUserLink" runat="server">Add Franchisee User</a>
            </td>
        </tr>
        <tr>
            <td>
                        ...
                        <td>
                            <asp:GridView Width="100%" ID="gvFranchiseeOwners" runat="server" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField ItemStyle-HorizontalAlign="Center" HeaderStyle-ForeColor="Blue" DataField="ContactNumber"
                                        HeaderText="Contact Number" SortExpression="ContactNumber" />
                                    <asp:TemplateField ShowHeader="False">
                                        <ItemTemplate>
                                            <a href="Detail.aspx?userId=<%#Eval("UserId")%>">View Detail...</a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
