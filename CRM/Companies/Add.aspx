<%@ page title="CRM - Add Company" language="C#" masterpagefile="~/CRM.master" autoeventwireup="true" inherits="AddCompany, App_Web_mpcqa2cy" %>
            ...
            <td style="width: 280px">
                ...
                <asp:ObjectDataSource ID="CompanyDataSource" runat="server" InsertMethod="InsertCompany" OnInserting="InsertOperation_Selecting"
                    ...
                    <InsertParameters>
                        ...
                        <asp:ControlParameter ControlID="dvCompany" Name="StartTime" PropertyName="SelectedValue" />
